...
const Hero = () => {
  return (
    <section className="min-h-screen pt-16 px-6 flex items-center bg-[#0f172a]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center lg:px-12 ">
        <div className="space-y-4 animate-fadeUp text-center lg:text-left">
          ...
          <div className="max-w-xl md:flex items-center gap-8">
            <Link
              to={"/projects"}
            ...
            <a
              ...
              target="_blank"
              className="bg-[#0f172a] text-gray-100 my-5  px-4 py-2 border border-gray-700 text-lg rounded-sm font-semibold shadow-lg hover:bg-gray-800 active:scale-95 transform transition-all cursor-pointer flex items-center justify-between "
            >
